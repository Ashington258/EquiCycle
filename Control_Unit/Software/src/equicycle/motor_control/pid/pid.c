...
CENTER_STRUCT motor_contl;
PID_ERECT roll_pid;
/*
    2024.9.14第一次直立
float offset_roll = -1.3;//改大往左倒
float param_roll_Gyro[4]  = {  4,    0,     0,     0};
float param_roll_Angle[4] = {  8,    0,     0,     0};
float param_roll_Speed[4] = {  0.04,   0,     0,    0};
 */
// 左右平衡
float param_roll_Gyro[4]  = {  7,    0,     3,     0};//6,20   4.2,10
float param_roll_Angle[4] = {  8,    0,     0.5,     0};//17,20   9,30
float param_roll_Speed[4] = {  0.04,   0,     0,    0};//0.0001   0.001

// 左右平衡零点
float offset_roll = 0.2;//改大往左倒
